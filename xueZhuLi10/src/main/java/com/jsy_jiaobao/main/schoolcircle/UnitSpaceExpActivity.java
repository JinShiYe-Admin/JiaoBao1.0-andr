			...
			for (UnitGroupInfo groupInfo : UnitGroupInfoList) {
				...
				for (int i = 0; i < list1.size(); i++) {
					...
					for (String group : groups) {
						if (group.equals(String.valueOf(groupInfo
								.getGroupID()))) {

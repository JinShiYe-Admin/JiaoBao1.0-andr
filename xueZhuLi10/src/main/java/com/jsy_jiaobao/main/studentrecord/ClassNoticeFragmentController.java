...
public class ClassNoticeFragmentController implements ConstantUrl{
	...
	public ClassNoticeFragmentController setContext(Fragment noticeFragment) {
	...
	public void PackMsgSch(String DATA){
		...
		callback.setUserTag(Constant.sturecord_home_PackMsgSch_clas);
	...
	public void StuMsgSch(String DATA){
		...
		params.addBodyParameter("DATA",DATA);
		CallBack callback = new CallBack();
		callback.setUserTag(Constant.sturecord_home_StuMsgSch_clas);
		HttpUtil.getInstance().send(HttpRequest.HttpMethod.POST, StuRecordDataGet, params, callback);
	}
	/**
	 * 返回第一页信息列表
	...
	private void dealResponseInfo(String result, Object userTag) {
		...
		case Constant.sturecord_home_PackMsgSch_clas:
			post.add(Constant.sturecord_home_PackMsgSch_clas);
			msgSch = GsonUtil.GsonToObject(result, MsgSch.class);
			post.add(msgSch);
			break;
		case Constant.sturecord_home_StuMsgSch_clas:
			post.add(Constant.sturecord_home_StuMsgSch_clas);
			msgSch = GsonUtil.GsonToObject(result, MsgSch.class);
			post.add(msgSch);
			break;
		default:

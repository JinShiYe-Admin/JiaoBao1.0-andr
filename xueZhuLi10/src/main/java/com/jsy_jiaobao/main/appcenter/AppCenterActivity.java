...
public class AppCenterActivity extends BaseActivity {
	...
	@ViewInject(R.id.appcenter_gridview)GridView gridView;
	@ViewInject(R.id.base_appcenter_layout) LinearLayout layout_ui;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new SimpleAdapter(mContext, data, R.layout.appcenter_gridview_item, new String[]{"item_image","item_name"}, new int[]{R.id.item_image,R.id.item_name});

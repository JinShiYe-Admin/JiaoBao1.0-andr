...
public class QiuZhiQuestionAnswerListActivity extends BaseActivity implements
	...
	private TextView tv_question;// 显示question标题View
	private TextView tv_topic;// 显示所属话题View
	...
	private TextView tv_invite;// 邀请回答
	private TextView tv_attquestion;// 关注问题
	private TextView tv_report;// 举报问题
	/***
	 * 全部 有证据 有内容 无内容
	 * 
	 * @功能 可筛选答案
	...
	private HashMap<Integer, ArrayList<AnswerItem>> dataMap = new HashMap<Integer, ArrayList<AnswerItem>>();
	private HashMap<Integer, Integer> pageNumMap = new HashMap<Integer, Integer>();
	private HashMap<Integer, Integer> RowCountMap = new HashMap<Integer, Integer>();
	private QuestionDetails questiondetails;
	private TextView tv_details;// 详情按钮

...
public class WorkFragment2 extends SherlockFragment implements
    ...
    private ArrayList<CommMsg> allMsgList = new ArrayList<>();
    private ArrayList<CommMsg> unreadMsgList = new ArrayList<>();
    private ArrayList<CommMsg> uncommentMsgList = new ArrayList<>();
    private ArrayList<CommMsg> commentedMsgList = new ArrayList<>();
    private ArrayList<CommMsg> frommeMsgList = new ArrayList<>();
        ...
        switch (tag) {
            ...
            case Constant.msgcenter_work2_CommListToMeCommented:// 已回复
                ...
                if (commented != null && commented.size() > 0) {
                    ...
                    commentedHaveMore=commented.size()==20;
                } else {
            ...
            case Constant.msgcenter_work2_CommListToMeUnComment:// 未回复
                ...
                if (uncomment != null && uncomment.size() > 0) {
                    ...
                    uncommentHaveMore=uncomment.size()==20;
                } else {

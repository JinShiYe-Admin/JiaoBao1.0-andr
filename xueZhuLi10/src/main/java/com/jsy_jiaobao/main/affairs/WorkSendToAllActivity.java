...
public class WorkSendToAllActivity extends BaseActivity implements PublicMethod,OnClickListener {
    ...
    private TextView tv_lowerunit;//下级单位 介绍
...
//		}
    ...
    private void injectViews() {
        ...
        tv_lowerunit = (TextView) findViewById(R.id.sendmessage_tv_lowerunit);//下级单位 介绍
        findViewById(R.id.sendmessage_btn_toall).setOnClickListener(this);
        findViewById(R.id.sendmessage_btn_invert).setOnClickListener(this);
...
//		params.addBodyParameter("toid",tomsgid);
    ...
    private void initRevicerList() {
        ...
        List<ClassRevicer> classRevicerList;
        ...
        public void onClick(View v) {
            try {
                ...
                if (tag == null) {
                    ...
                    List<GroupUserList> UserList = new ArrayList<>();
                    UserList.add(itemS);

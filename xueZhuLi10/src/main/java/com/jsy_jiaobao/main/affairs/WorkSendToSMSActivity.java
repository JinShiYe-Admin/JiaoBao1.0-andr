...
public class WorkSendToSMSActivity extends BaseActivity implements PublicMethod, OnClickListener {
    ...
    private List<SMSTreeUnitID> reciverSMSListTea = new ArrayList<>();
    private List<SMSTreeUnitID> reciverSMSListPar = new ArrayList<>();
    private List<SMSTreeUnitID> reciverSMSListStu = new ArrayList<>();
    ...
    public void initViews() {
        ...
        LinearLayout layout_content = (LinearLayout) findViewById(R.id.sendmessage_layout_content);
            ...
            case R.id.sendmessage_btn_send:
                ...
                if ("".equals(str_msgcontent)) {
                    ...
                    for (int i = 0; i < grids.size(); i++) {
                        ...
                        SparseArray<List<SMSTreeUnitID>> list = adapter.getCheckedSMS();
                        if (list.get(1) != null) {

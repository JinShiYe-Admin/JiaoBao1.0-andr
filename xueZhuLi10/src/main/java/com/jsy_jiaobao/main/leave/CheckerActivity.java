...
public class CheckerActivity extends BaseActivity implements OnClickListener,
	 ...
	 * 选择的审核人名称
	 */
	private String mBackCheckerName;// 选择的审核人名称
	/**
	 * 时间
	 */
	...
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-DD",
			Locale.getDefault());
	private ArrayList<String> approvalStuNoteList;// 审核学生名称
	private ArrayList<String> approvalNoteList;// 审核教职工名称
	private ArrayList<Integer> approvalList;// 审核学生权限级数
	private ArrayList<Integer> approvalStuList;// 审核教职工权限级数
	private ArrayList<GateQueryLeaveModel> gateLeaveList;// 门卫审核假条列表
	private ArrayList<UnitClassLeaveModel> leaveList;// 假条列表
	private HashMap<Integer, Object> mCheckTypeGradeClassMap;
	...
	private TextView tv_null;// 空白区域，只有门卫审核权限时，用于将布局居中
	private TextView tv_null2;// 空白区域，只有门卫审核权限时，用于将布局居中
	...
	private void getBasicData() {
		...
		leaveList = new ArrayList<UnitClassLeaveModel>();
		gateLeaveList = new ArrayList<GateQueryLeaveModel>();
		mCheckTypeGradeClassMap = new HashMap<Integer, Object>();

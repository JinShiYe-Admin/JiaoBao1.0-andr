...
public class CheckerScreenConditionActivity extends BaseActivity implements
    ...
    private static final String TAG = "ChSnCnActy";
    ...
    private void initViews() {
        ...
        TextView tv_symbol = (TextView) findViewById(R.id.tv_symbol);// 时间
        ...
        realGradeList = new ArrayList<>();
        classNameList = new ArrayList<>();
        headChoseGradeClassList = new ArrayList<>();
        gradeClass = new ArrayList<>();
        headGradeClass = new ArrayList<>();
    ...
    private void getApprovalInfo() {
        approvalNoteList = new ArrayList<>();
        approvalStuNoteList = new ArrayList<>();
        approvalList = new ArrayList<>();
        approvalStuList = new ArrayList<>();
    ...
    public void onEventMainThread(ArrayList<Object> list) {
        ...
        switch (tag) {
            case LeaveConstant.leave_GetMyAdminClass:// 班主任获取关联的班级
                ...
                ArrayList<AdminClassModel> classModelList = myAdminClasses.getList();
                ...
                SpinnerAdapter gradeAdapter = new SpinnerAdapter(mContext, realGradeList);
            ...
            case LeaveConstant.leave_getunitclass:
                ...
                ArrayList<UserClassInfoModel> userClassModelList = userClassList.getList();
                classNameList.clear();
                gradeNameList = new ArrayList<>();
                ...
                for (int i = 0; i < classlist.size(); i++) {
                    ArrayList<UserClassInfoModel> s = new ArrayList<>();
                    HashMap<String, ArrayList<UserClassInfoModel>> jh = new HashMap<>();

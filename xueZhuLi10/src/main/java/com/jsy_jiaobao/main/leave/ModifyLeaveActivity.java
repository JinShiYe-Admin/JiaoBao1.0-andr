...
public class ModifyLeaveActivity extends BaseActivity implements
	...
	private UpdateLeaveModelPost updatePost;// 更新假条信息
	...
	private TextView tv_timeAdd;// 增加时间段
	...
	private void initViews() {
		...
		originalLeaveTime = new ArrayList<LeaveTime>();
	...
	public void onEventMainThread(ArrayList<Object> list) {
		...
		case LeaveConstant.leave_GetLeaveModel://获取假条，判断是否是等待中
			...
			LeaveDetail choseLeaveCommit = new LeaveDetail();
			choseLeaveCommit = (LeaveDetail) list.get(1);
			if (commit) {
				if (choseLeaveCommit != null && !choseLeaveCommit.equals("")

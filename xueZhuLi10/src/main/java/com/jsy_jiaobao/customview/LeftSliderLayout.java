...
public class LeftSliderLayout extends ViewGroup {
    ...
    /**
     * Values for VelocityTracker to compute current velocity.//閫熷害
     ...
     * mDockWidth in px
     */
    private static final float SLIDING_WIDTH = 250.0f;			
    private int mSlidingWidth;									
    
    /**
     * The default values of shadow.//褰卞瓙
     * VELOCITY_UNITS in dp
     * mVelocityUnits in px
     */
    ...
    /**
     * Value for saving the last offset of scroller 閳�?x-axis.
     */
...
//        mSlidingWidth = (int) (SLIDING_WIDTH * fDensity + 0.5f);
	...
	public boolean onTouchEvent(MotionEvent event) { 
    	...
    	if (mIsTouchEventDone&&mMainChild != null) {
    ...
    public interface OnLeftSliderLayoutStateListener { 
    	...
    	/**
    	 * Called when LeftSliderLayout閳ユ獨 state has been changed.
    	 * 
    	 * @param bIsOpen the new state
    	 */

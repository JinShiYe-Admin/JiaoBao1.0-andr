...
public class Constant {
	...
	public static final String YINSI_URL="https://www.jiaobaowang.net/dl/jbPrivacy.htm";
	public static final String KNOWN_URL="https://www.jiaobaowang.net/dl/jbPrivacy.htm";

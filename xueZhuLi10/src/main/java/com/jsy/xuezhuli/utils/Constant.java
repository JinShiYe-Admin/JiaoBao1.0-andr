...
public class Constant {
	...
	public static final String YINSI_URL="http://hao.jiaobaowang.net/appdl/jb/jbPrivacy.htm";
	public static final String KNOWN_URL="http://hao.jiaobaowang.net/appdl/jb/jbPrivacy.htm";
	...
	public static final String KNOWN = "依据最新法律要求，我们更新了<a target='_blank' href="+YINSI_URL+">《用户隐私政策》</a> 请您务必审慎阅读,充分理解相关条款内容，特别是字体加粗标识的重要条款。\n"+
			"<br>点击同意即代表您已阅读并同意<a target='_blank' href="+YINSI_URL+">《用户隐私政策》</a>,如果您不同意用户隐私政策的内容，我们暂时将无法为您提供服务\n" +
			"<br>我们会尽力保护您的个人信息安全。";
	public static final String NO_PASS_TEXT = "由于您不同意《用户隐私政策》的相关内容，我们暂时无法为您提供服务。请谅解！";

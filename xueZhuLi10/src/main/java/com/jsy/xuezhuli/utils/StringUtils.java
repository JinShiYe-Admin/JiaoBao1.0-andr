...
public class StringUtils {
	 ...
	 * @return px
	 */
	public static int dipToPixels(Context mContext, int dip) {
	 ...
	 * @return
	 */
	public static String autoPlayJS(String id) {
		StringBuilder sb = new StringBuilder();
		sb.append("<script type=\"text/javascript\">");
		sb.append("function autoplay() {");
		sb.append("var video = document.getElementById(" + id + ");");
		sb.append("video.loop = 'loop';");
